...
describe('optionDescription', () => {
  it('when option has no description then empty string', () => {
    const option = new commander.Option('-a');
    const helper = new commander.Help();
    expect(helper.optionDescription(option)).toEqual('');
  });

  it('when option has description then return description', () => {
  ...
  it('when boolean option has default value true then return description and default value', () => {
    const description = 'description';
  ...
  it('when boolean option has default value string then return description without default', () => {
    const description = 'description';
  ...
  it('when optional option has preset value then return description and default value', () => {
    const description = 'description';
  ...
  it('when boolean option has preset value then return description without default', () => {
    const description = 'description';
    const option = new commander.Option('--bb', description).preset('abc');
    const helper = new commander.Help();
    expect(helper.optionDescription(option)).toEqual('description');
  });
  it('when option has env then return description and env name', () => {
    const description = 'description';
  ...
  it('when option has default value description then return description and custom default description', () => {
    const description = 'description';
  ...
  it('when option has choices then return description and choices', () => {
    const description = 'description';
