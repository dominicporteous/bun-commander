...
describe('regression tests', () => {
  ...
  // https://github.com/tj/commander.js/issues/1032
  it('when specify subcommand and argument then program.args not empty', () => {
  ...
  // https://github.com/tj/commander.js/issues/1032
  it('when specify subcommand and option and argument then program.args not empty', () => {
    const program = createProgram1032();
  ...
  it('when arguments to executable include option flags then argument order preserved', async() => {
    const pm = path.join(__dirname, 'fixtures/pm');
    const res = await execFileAsync('bun', ['run', pm, 'echo', '1', '2', '--dry-run', '3', '4', '5', '6'])
    expect(res.trim()).toEqual('[ "1", "2", "--dry-run", "3", "4", "5", "6" ]');
  });
});
...
describe('parse and program.args', () => {
  it('when program has known flag and operand then option removed and operand returned', () => {
    const program = new commander.Command();
    program
      .option('--global-flag');
  ...
  it('when program has mixed arguments then known options removed and rest returned in same order', () => {
    const program = new commander.Command();
    program
      .allowUnknownOption()
      .option('--global-flag')
  ...
  it('when subcommand has mixed arguments then program flags removed and rest returned in same order', () => {
    const program = new commander.Command();
    program
      .option('--global-flag')
      .option('--global-value <value>')
...
describe('Utility Conventions', () => {
  ...
  it('when program has combo known boolean short flags then arg removed', () => {
    const program = createProgram();
  ...
  it('when program has combo unknown short flags then arg preserved', () => {
    const program = createProgram();
  ...
  it('when program has combo known short option and required value then arg removed', () => {
    const program = createProgram();
  ...
  it('when program has combo known short option and optional value then arg removed', () => {
    const program = createProgram();
  ...
  it('when program has known combo short boolean flags and required value then arg removed', () => {
    const program = createProgram();
  ...
  it('when program has known combo short boolean flags and optional value then arg removed', () => {
    const program = createProgram();
  ...
  it('when program has known long flag=value then arg removed', () => {
    const program = createProgram();
  ...
  it('when program has unknown long flag=value then arg preserved', () => {
    const program = createProgram();
  ...
  it('when program has combo optional and combineFlagAndOptionalValue() then treat as value', () => {
    const program = createProgram();
  ...
  it('when program has combo optional and combineFlagAndOptionalValue(true) then treat as value', () => {
    const program = createProgram();
  ...
  it('when program has combo optional and combineFlagAndOptionalValue(false) then treat as boolean', () => {
    const program = createProgram();
