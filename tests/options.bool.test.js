...
describe('boolean flag on program', () => {
  it('when boolean flag not specified then value is undefined', () => {
  ...
  it('when boolean flag specified then value is true', () => {
    const program = new commander.Command();
    program
      .option('--pepper', 'add pepper');
  ...
  it('when negatable boolean flag not specified then value is true', () => {
    const program = new commander.Command();
    program
  ...
  it('when negatable boolean flag specified then value is false', () => {
    const program = new commander.Command();
    program
      .option('--no-cheese', 'remove cheese');
...
describe('boolean flag with non-boolean default', () => {
  it('when flag not specified then value is "default"', () => {
  ...
  it('when flag specified then value is true', () => {
    const flagValue = 'black';
    const program = new commander.Command();
    program
  ...
  it('when combo flag and negated then value is false', () => {
    const flagValue = 'black';
    const program = new commander.Command();
    program
      .option('-v, --olives', 'Add green olives?', flagValue)
...
describe('regression test for -no- in middle of option flag', () => {
  it('when flag not specified then value is undefined', () => {
    const program = new commander.Command();
    program
