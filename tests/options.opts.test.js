...
it('when .version used with storeOptionsAsProperties() then version in opts', () => {
...
it('when .version used with storeOptionsAsProperties(false) then version not in opts', () => {
...
// Behaviour is slightly different compared to Node
// Node expected result would be {}
// Bun returns { pepper: undefined }

for(const storeOptionsAsProperties of [true, false]){
  describe(`storeOptionsAsProperties is ${storeOptionsAsProperties}`, () => {
    it('when boolean flag not specified then not in opts', () => {
      const program = new commander.Command();
      program.storeOptionsAsProperties(storeOptionsAsProperties);
      program
        .option('--pepper', 'add pepper');
      program.parse(['node', 'test']);
      expect(program.opts()).toEqual(storeOptionsAsProperties ? { pepper: undefined } : {});
    });

    it('when boolean flag specified then value true', () => {
      const program = new commander.Command();
      program.storeOptionsAsProperties(storeOptionsAsProperties);
      program
        .option('--pepper', 'add pepper');
    ...
    it('when option with required value not specified then not in opts', () => {
      const program = new commander.Command();
      program.storeOptionsAsProperties(storeOptionsAsProperties);
      program
    ...
    it('when option with required value specified then value as specified', () => {
    ...
    it('when option with default value not specified then default value in opts', () => {
