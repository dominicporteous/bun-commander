...
it('when createCommand then unattached', () => {
...
it('when subclass overrides createCommand then subcommand is subclass', () => {
...
it('when override createCommand then subcommand is custom', () => {
